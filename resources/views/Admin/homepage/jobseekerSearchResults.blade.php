...
<section class="content-header">
	<h1>
		<span style="color:#d73925;"><b>Admin</b> </span> JobSeeker Search Results
		<small>View JobSeeker Search Results</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">JobSeeker Search Results</li>
	</ol>
</section>
...
<section class="content">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><strong><span style="color: #367fa9;">jason</span></strong></h3>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<button class="btn btn-primary btn-block"><b class="glyphicon glyphicon-copy"></b> <strong>Approach</strong></button>
							</div>
						</div>
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><strong><span style="color: #367fa9;">lolwa</span></strong></h3>
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><strong><span style="color: #367fa9;">Bro</span></strong></h3>
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><strong><span style="color: #367fa9;">Glasses</span></strong></h3>
