...
<section class="content-header">
	<h1>
		<span style="color:#d73925;"><b>Admin</b> </span> Jobseeker Search
...
<script type="text/javascript" id="hits-temp">
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><strong><span class="text-primary"><span class="text-muted">@{{id}} &nbsp &nbsp</span>@{{firstname}} @{{middlename}} @{{lastname}}</span></strong></h3>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<a href="/admin/viewJobseekerProfile/@{{id}}">
								<button class="btn btn-primary btn-block"><b class="glyphicon glyphicon-copy"></b> <strong>View Profile</strong>
								</button>
								</a>
							</div>
						</div>
