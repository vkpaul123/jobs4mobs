...
<section class="content-header">
	<h1>
		<span style="color:#d73925;"><b>Admin</b> </span> Vacancy Search Results
...
<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title"><strong><span style="color: #008d4c;">Nvidia</span></strong></h3>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<button class="btn btn-success btn-block"><b class="glyphicon glyphicon-copy"></b> <strong>Apply</strong></button>
						</div>
					</div>
