	 ...
	 <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-6">
	 			...
	 			<p><br/><a href="employer/contact" class="btn btn-theme">Contact Us</a></p>
	 		</div>
	 	</div><! --/row -->
	 </div><! --/container -->
	 ...
	 ***************************************************************************************************************** -->
	 ...
	 <div class="container mtb">
	 	<div class="row centered">
	 		...
	 		<div class="col-lg-3 col-md-3 col-sm-3">
	 			<div class="he-wrap tpl6">
	 				<img src="{{ asset('assets/welcomePage/img/team/team02.jpg') }}" alt="">
	 				<div class="he-view">
	 					<div class="bg a0" data-animate="fadeIn">
	 						<h3 class="a1" data-animate="fadeInDown">Contact Me:</h3>
	 						<a href="#" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-envelope"></i></a>
	 		...
	 		<div class="col-lg-3 col-md-3 col-sm-3">
	 			<div class="he-wrap tpl6">
	 				<img src="{{ asset('assets/welcomePage/img/team/team04.jpg') }}" alt="">
	 				<div class="he-view">
	 					<div class="bg a0" data-animate="fadeIn">
	 						<h3 class="a1" data-animate="fadeInDown">Contact Me:</h3>
	 						<a href="#" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-envelope"></i></a>
