		...
		<div class="box-body">
			...
			<form action="{{ route('profile.store') }}" method="post" class="form-horizontal" role="form">
				...
				<div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="experience" name="experience" placeholder="(Years)" min="0" value="{{ old('experience') }}" maxlength="2">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('preferedsalary') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" maxlength="7" class="form-control pull-right" id="preferedsalary" name="preferedsalary" placeholder="(Salary)" min="0" value="{{ old('preferedsalary') }}">
					</div>
				</div>
