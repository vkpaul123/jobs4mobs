...
<section class="content-header">
	<h1>
		<span style="color:#367fa9;"><b>JobSeeker</b> </span> Profile Registration Edit
		<small>Set up your Profile</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Register Profile Edit</li>
	</ol>
</section>
		...
		<div class="box-body">
			...
			<form action="{{ route('profile.update', $jobseekerProfile->id) }}" method="post" class="form-horizontal" role="form">
				...
				<div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="firstname" name="firstname" placeholder="First Name" value="{{ $jobseekerProfile->firstname }}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="middlename" name="middlename" placeholder="Middle Name" value="{{ $jobseekerProfile->middlename }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="lastname" name="lastname" placeholder="Last Name" value="{{ $jobseekerProfile->lastname }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('dateOfBirth') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<div class="input-group date">
							<input type="text" class="form-control pull-right" id="dateOfBirth" name="dateOfBirth" placeholder="yyyy-mm-dd" value="{{ $jobseekerProfile->dateOfBirth }}">
				...
				<div class="form-group{{ $errors->has('preferedcityofwork') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="preferedcityofwork" name="preferedcityofwork" placeholder="Prefered City Of Work" value="{{$jobseekerProfile->preferedcityofwork}}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('preferedcountryofwork') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="preferedcountryofwork" name="preferedcountryofwork" placeholder="Prefered Country Of Work" value="{{$jobseekerProfile->preferedcountryofwork}}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('tagline') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<textarea class="form-control pull-right" id="tagline" name="tagline" placeholder="Tag Line" rows="3" style="resize: none;">{{ $jobseekerProfile->tagline }}</textarea>
					</div>
				</div>
...
<script>
	...
	$("#gender").val("{{ $jobseekerProfile->gender }}").trigger('change');
	$("#educationlevel").val("{{ $jobseekerProfile->educationlevel }}").trigger('change');
	$("#recentJobCategoryId").val("{{ $jobseekerProfile->recentJobCategoryId }}").trigger('change');
	$("#preferedJobCategoryId1").val("{{ $jobseekerProfile->preferedJobCategoryId1 }}").trigger('change');
	$("#preferedJobCategoryId2").val("{{ $jobseekerProfile->preferedJobCategoryId2 }}").trigger('change');
	$("#preferedworktype").val("{{ $jobseekerProfile->preferedworktype }}").trigger('change');
