...
<section class="content-header">
	<h1>
		<span style="color:#367fa9;"><b>JobSeeker</b> </span> Search Employer
		<small>look for an Employer</small>
	</h1>
	<ol class="breadcrumb">
				...
				<form action="" method="post" class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-md-10 col-md-offset-1">
							<div class="row">
								<div class="col-md-8">
									<input type="text" id="searchName" name="searchName" class="form-control" placeholder="Employer Name">
								</div>
