...
<section class="content">
	...
	<div class="box">
		...
		@endif
			...
			<form action="{{ route('skills.update', $skillsEdit->id) }}" method="post" class="form-horizontal">
				{{csrf_field()}}
				{{ method_field('PUT') }}
				...
				<div class="form-group{{ $errors->has('proficiencyLevel') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="proficiencyLevel" name="proficiencyLevel" placeholder="Proficiency Level" value="{{ $skillsEdit->proficiencyLevel }}">
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-offset-7 col-md-4">
				<a href="{{ route('resume.show', $skillsEdit->jobseeker_profiles_id) }}"><button type="button" class="btn btn-success btn-block pull-right btn-lg"><strong>Done</strong></button></a>
			</div>
		</div>
	</div>
