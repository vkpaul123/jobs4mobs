...
<section class="content-header">
    <h1>
        <span style="color:#367fa9;"><b>JobSeeker</b> </span> View Resume
        <small>view your Resume</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title"><strong>Resume</strong></h3>

            <div class="box-tools pull-right">
                <a href="{{ route('profile.show', $resume->id) }}"><button class="btn btn-primary"><strong>View Profile</strong></button></a>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3><span class="text-info"><strong>Tools</strong></span>&nbsp <small>Add Details</small></h3>
                            <hr>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="container-fluid">
                                    <strong class="text-info">Resume Completion</strong>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="{{ $resumeCompletion }}" aria-valuemin="0" aria-valuemax="100" style="width:{{ $resumeCompletion }}%">
                                          {{ $resumeCompletion }}%
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <a href="{{ route('experience.show', $resume->id) }}"><button class="btn btn-default btn-lg btn-block"><strong>Experiences</strong></button></a><br>
                            <a href="{{ route('academics.show', $resume->id) }}"><button class="btn btn-default btn-lg btn-block"><strong>Education</strong></button></a><br>
                            <a href="{{ route('skills.show', $resume->id) }}"><button class="btn btn-default btn-lg btn-block"><strong>Skill</strong></button></a><br>
                            <a href="{{ route('achievements.show', $resume->id) }}"><button class="btn btn-default btn-lg btn-block"><strong>Achievements</strong></button></a><br>
            ...
            @else
                ...
                <div class="box-body">
                    ...
                    <br>
                        <div class="jumbotron">
                            <center>
                                <h4><span class="fa fa-exclamation-triangle"></span> &nbsp <span class="text-danger">You Don't have any Resume created.<br><small>Please Create a Resume.</small></span></h4>
                                <br>
                                <button type="button" class="btn btn-info btn-lg">Create New Resume</button>
                            </center>
                        </div>
                    </div>
                </div>
    ...
    <input type="hidden" value="{{ Auth::user()->id }}" id="jobseekerNameForPrinting">
</section>
