<aside class="main-sidebar" style="background-color: #384452;">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="{{ route('vacancies.index', Auth::user()->id) }}"><i class="fa fa-circle-o text-aqua"></i> <span>Vacancies</span></a></li>
      <li><a href="{{ route('questionnareBuilder.index') }}"><i class="fa fa-circle-o text-aqua"></i> <span>Questionnaire Builder</span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>