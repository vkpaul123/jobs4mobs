...
<section class="content-header">
	<h1>
		<span style="color:#e08e0b;"><b>Employer</b> </span> Open Vacancy
		<small>Open a Job Vacancy</small>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="box-body">
			...
			<form action="{{ route('vacancy.store') }}" method="post" class="form-horizontal">
				...
				<div class="form-group{{ $errors->has('openingDate') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<div class="input-group date">
							<input type="text" class="form-control pull-right" id="openingDate" name="openingDate" placeholder="yyyy-mm-dd" value="{{ old('openingDate') }}">
				...
				<div class="form-group{{ $errors->has('closingDate') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<div class="input-group date">
							<input type="text" class="form-control pull-right" id="closingDate" name="closingDate" placeholder="yyyy-mm-dd" value="{{ old('closingDate') }}">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</div>
						</div>
				...
				<div class="form-group{{ $errors->has('jobdesignation') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="jobdesignation" name="jobdesignation" placeholder="Job Designation" value="{{ old('jobdesignation') }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('jobSpecification') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="jobSpecification" name="jobSpecification" placeholder="Job Specification" value="{{ old('jobSpecification') }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('jobDescription') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<textarea class="form-control pull-right" id="jobDescription" name="jobDescription" placeholder="Job Description" rows="5">{{ old('jobDescription') }}</textarea>
					</div>
				</div>
				...
				<div class="checkbox icheck col-md-offset-3 col-md-6">
					<label>
						<input type="checkbox" name="testrequired" {{ old('testrequired') ? 'checked' : '' }}> &nbsp Test Required
					</label>
				</div>
				<br>
				...
				<div class="form-group box-body pad">
					{{-- <form> --}}
						...
						style="width: 100%; height: 200px; font-family: Arial; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="vacancydescription" id="vacancydescription">{{ old('vacancydescription') }}</textarea>
					{{-- </form> --}}
				</div>
