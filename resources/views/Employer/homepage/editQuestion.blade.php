		...
		<div class="box-body">
			...
			<form action="{{ route('question.update', $question->id) }}" method="post" class="form-horizontal">
				...
				<div class="form-group{{ $errors->has('quesText') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<textarea class="form-control pull-right" id="quesText" name="quesText" placeholder="Question Text" rows="7">{{ $question->quesText }}</textarea>
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('correctAns') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="correctAns" name="correctAns" placeholder="Correct Answer" value="{{ $question->correctAns }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('WrongAns1') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="WrongAns1" name="WrongAns1" placeholder="Wrong Answer 1" value="{{ $question->WrongAns1 }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('WrongAns2') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="WrongAns2" name="WrongAns2" placeholder="Wrong Answer 2" value="{{ $question->WrongAns2 }}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('WrongAns3') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="WrongAns3" name="WrongAns3" placeholder="Wrong Answer 3" value="{{  $question->WrongAns3  }}">
					</div>
				</div>
...
<script>
	...
	$("#questionnaire_id").val("{{ $question->questionnaire_id }}").trigger('change');
</script>
